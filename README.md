...
> **Note:** SQL Server 2025 vector operations are functional on Macs with M-series CPUs via Rosetta 2, but using Orbstack see this [blog post](https://www.nocentino.com/posts/2025-11-26-sql-server-2025-docker-desktop-avx-issue/)
